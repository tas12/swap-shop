...
const header = require('../public/tags/app-header.tag')
const tagOutput = riot.render(header)
...
server.register(plugins, (err) => {
  ...
  server.route([{
    ...
    handler: (request, reply) => {
      reply.view('index', { header: tagOutput })
    }
  },
  {
    method: 'GET',
    ...
    handler: (request, reply) => {
      getPhotos
        .then(() => reply.view('index', { header: tagOutput }))
        .catch((error) => {
