...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;/* Riot v2.6.3, @license MIT */
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('app', '<div id="content" class=""></div>', '', 'class="app"', function (opts) {});
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('shop', '<div id="spinner"> <material-spinner></material-spinner> </div> <div class="flex-container"> <div class="flex-item" each="{img in img_arr}"> <img riot-src="{img}" style="width: 100%;"> </div> </div> <p> {offline} </p>', '.flex-item { margin: 0px 10px 20px 10px; width: 350px; max-width: 95%; height: auto; display: inherit; } .flex-container { display: inline-block; max-width: 90%; margin: 0 auto; }', '', function (opts) {
	  var self = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('add-item', '<video id="video" autoplay></video> <canvas id="canvas" class="hide"></canvas> <theme-button id="captureButton" text="Take photo" onclick="{capture}"></theme-button> <button class="hide" name="cancelButton">Cancel</button> <form></form> <theme-button class="hide" id="saveButton" text="Save" onclick="{save}">Save</theme-button>', 'video, canvas { display: block; margin: 0 auto; max-width: 100%; } video { border: 1px solid orange; } canvas { border: 1px solid pink; }', '', function (opts) {
	  var _this = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('form', '<div class="inputContent"> <material-input label="Item name"></material-input> <material-input label="Description"></material-input> <material-input label="Size"></material-input> <material-input label="Colour"></material-input> </div>', 'material-input { display: block; width: 450px; max-width: 90%; margin: 0 auto; text-align: left; } .inputContent input { font-size: 1em; } .inputContent label { color: #717373; }', '', function (opts) {});
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('theme-button', '<div id="{opts.id}">{opts.text}</div>', 'theme-button { display: block; margin: 10px auto 0 auto; background-color: #00bcd4; color: white; padding: 10px; border-radius: 3px; width: 100px; text-align: center; }', '', function (opts) {});
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('account', '<p>Coming soon</p>', '', '', function (opts) {});
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('about', '<h2>Changing the way we shop</h2> <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>', 'h2 { font-family: \'Bangers\'; letter-spacing: 1px; }', '', function (opts) {});
