...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('app', '<div id="content" class="flex-container"></div>', '', 'class=""', function (opts) {});
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('add', '<video id="video" autoplay></video> <canvas id="canvas" class="hide" width="400"></canvas> <button name="captureButton" onclick="{capture}">Take photo</button> <button class="hide" name="saveButton" onclick="{save}">Save</button> <button class="hide" name="cancelButton">Cancel</button> <img src="" alt=""> <material-input placeholder="Item name"></material-input> <material-input placeholder="Description"></material-input> <material-input placeholder="Size"></material-input> <material-input placeholder="Colour"></material-input>', '', '', function (opts) {
	  var _this = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('sample', '<div id="spinner"> <material-spinner></material-spinner> </div> <div class="flex-item" each="{img in img_arr}" style="max-width: 85%;"> <img riot-src="{img}" style="width: 100%; margin: 0px 0px 10px 0px;"> </div> <p> {offline} </p>', '', '', function (opts) {
	  var self = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('menu-item', '<div style="text-align: center"> <a href="{\'/\' + opts.name}" style="text-decoration: none">{opts.name}</a> </div>', '', 'style="width: 25%; line-height: 50px;"', function (opts) {});
